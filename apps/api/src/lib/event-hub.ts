...
// A orchestrator-level event: an agent-server event (tagged with its project) or a
// project lifecycle change (start/stop). orchestrator web's project list subscribes
 ...
 * into a single emitter that orchestrator web can subscribe to once.
 *
...
export class EventHub {
	...
	/** Re-broadcast an event to every subscribed orchestrator web client. */
