...
export const requestLogger: MiddlewareHandler<HonoOrchestratorEnv> = async (context, next) => {
...
export const responseLogger: MiddlewareHandler<HonoOrchestratorEnv> = async (context, next) => {
