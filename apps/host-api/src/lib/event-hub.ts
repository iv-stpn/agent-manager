...
// A host-level event: an agent-server event (tagged with its project) or a
// project lifecycle change (start/stop). host-web's project list subscribes
 ...
 * into a single emitter that host-web can subscribe to once.
 *
...
export class EventHub {
	...
	/** Re-broadcast an event to every subscribed host-web client. */
