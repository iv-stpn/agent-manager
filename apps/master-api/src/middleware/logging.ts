...
export const requestLogger: MiddlewareHandler<HonoMasterEnv> = async (context, next) => {
...
export const responseLogger: MiddlewareHandler<HonoMasterEnv> = async (context, next) => {
